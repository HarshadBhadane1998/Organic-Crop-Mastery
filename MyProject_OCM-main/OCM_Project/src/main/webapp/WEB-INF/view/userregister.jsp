       ...
       <div class="col-md-4 offset-md-4 admin" >
           ...
           <div class="form-group">
                 ...
                 <div class="form-group">
                     ...
                     <input type="text" class="form-control" id="username" aria-describedby="emailHelp" name="username" placeholder="Enter username" pattern="^[A-Za-z0-9_]{2,32}$" title="You can use alphabet, number or undserscore only" required>
                 </div>
                 ...
                 <div	class="form-row">
                     ...
                     <input type="text" class="form-control" id="mobileno" aria-describedby="emailHelp" name="mobileno" placeholder="Enter mobile no" pattern="[7-9]{1}[0-9]{9}" title="Please enter the valid mobile number" required>
                 	</div>
